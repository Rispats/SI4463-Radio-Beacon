...
<p align = "center">
<img width="250" height="250" alt="Screenshot from 2025-09-16 21-53-05" src="https://github.com/user-attachments/assets/00c07dfb-4116-4019-940d-fc2f95081034"/>
</p>

## *PIN CONNECTIONS*
### 1) Arduino Nano ESP32-S3 to SI4463:
Arduino Nano ESP32-S3 | SI4463
:---: | :------:
3.3V | Vcc
Gnd | Gnd
D7 | SDN
...
### 2) Arduino Nano ESP32-S3 to EVE GNSS L89:
Arduino Nano ESP32-S3 | EVE GNSS L89
:---: | :------:
3.3V | 3.3V
Gnd | Gnd
D3 | RX
